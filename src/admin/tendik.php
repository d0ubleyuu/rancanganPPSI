        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
          <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
               ...
               <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
                 ...
                 <li>
                   <div class="flex items-center">
                     ...
                     <span class="ms-1 text-sm font-medium text-gray-700 md:ms-2 dark:text-gray-400 dark:hover:text-white">Guru dan Tendik</a>
                   </div>
                 </li>
               </ol>
             </nav>
             <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Kelola Guru dan Tendik</h2>
            </div> 
            <div
            ...
            > 
              ...
              >
                <div class="flex-1 flex items-center space-x-2">
                  <h5>
                    ...
                    <span class="dark:text-white"><?=(isset($_GET['KataKunci'])) ? 'Search('.$_GET['KataKunci'].')' : "Semua Sekolah";?></span>
                  </h5>
                </div>
              </div>
              <div
                ...
                >
                  ...
                  >
                    <tr>
                      ...
                      <th scope="col" class="p-4">Instansi</th>
                  ...
                  // $tendik = mysqli_query($koneksi, "SELECT * from mhs_web  order by nim ");
                  $no = 1;
                  foreach ($tendik as $row) { ?>
                    <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                              ...
                              <td class="pl-8 px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              ...
                              <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <?php 
                                $biru = ($row['jabatan'] == 'Pengawas') ? ' class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300"' : '';
                                $kuning = ($row['jabatan'] == 'Guru') ? ' class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300"' : '';
                                $merah = ($row['jabatan'] == 'Kepsek') ? ' class="bg-red-100 text-red-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-red-900 dark:text-red-300"' : '';
                                ?>
              ...
              //kondisi jika parameter pencarian kosong
              if ($kolomKataKunci == "") {
                $countStmt = mysqli_query($koneksi,"SELECT COUNT(*) AS total_baris FROM tendik");
              } else {
                //kondisi jika parameter kolom pencarian diisi 
                $countStmt = mysqli_query($koneksi,"SELECT COUNT(*) AS total_baris FROM tendik INNER JOIN sekolah ON tendik.id_sekolah = sekolah.id WHERE sekolah.nama LIKE '%$kolomKataKunci%' OR tendik.nama LIKE '%$kolomKataKunci%' OR tendik.nip LIKE '%$kolomKataKunci%' OR tendik.jk LIKE '%$kolomKataKunci%' OR tendik.jabatan LIKE '%$kolomKataKunci%' OR tendik.pendidikan LIKE '%$kolomKataKunci%'");
              }
              $result = mysqli_fetch_assoc($countStmt);
              //Hitung semua jumlah data yang berada pada tabel Sisawa
              $JumlahData = $result['total_baris'];
              ...
              ?>
                ...
                <ul class="inline-flex items-stretch -space-x-px">
                  ...
                  <li>
                    <a
                      href="tendik.php?page=<?php echo $LinkPrev; ?>"
                  ...
                  <li>
                    <a
                      href="tendik.php?KataKunci=<?php echo $kolomKataKunci; ?>&page=<?php echo $LinkPrev; ?>"
                      class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"                      
                      >
                      <span class="sr-only">Previous</span>
                      <svg
                  ...
                  <?php                    
                    ...
                    ?>
                            <li <?php echo $linkActive; echo $linkNonActive;?>>
                              <a
                                href="tendik.php?page=<?php echo $i; ?>"
                            ...
                            ?>
                                <li <?php echo $linkActive; echo $linkNonActive;?>>
                                <a href="tendik.php?KataKunci=<?php echo $kolomKataKunci; ?>&page=<?php echo $i; ?>"
